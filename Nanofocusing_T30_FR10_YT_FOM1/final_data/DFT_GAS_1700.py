...
os.makedirs('DFT_GAS_1700',exist_ok=True) # Create Folder
os.makedirs('DFT_mode_volume_1700',exist_ok=True) # Create Folder
os.makedirs('DFT_mode_volume_emp_1700',exist_ok=True) # Create Folder
os.makedirs('DFT_empty_GAS_1700',exist_ok=True) # Create Folder
os.makedirs('DFT_charge_density_1700',exist_ok=True) # Create Folder
...
wavelengths = np.array([1.70])     # wavelengths = np.array([1.5 ,1.55, 1.6])
frequencies = np.array([1 / 1.70])
...
np.save('DFT_GAS_1700/Dft_GAS_Ex_xz.npy',Ex_xz)
np.save('DFT_GAS_1700/Dft_GAS_Ey_xz.npy',Ey_xz)
np.save('DFT_GAS_1700/Dft_GAS_Ez_xz.npy',Ez_xz)
...
np.save('DFT_GAS_1700/Dft_GAS_Ex_yz.npy',Ex_yz)
np.save('DFT_GAS_1700/Dft_GAS_Ey_yz.npy',Ey_yz)
np.save('DFT_GAS_1700/Dft_GAS_Ez_yz.npy',Ez_yz)
...
np.save('DFT_GAS_1700/Dft_GAS_Ex_xyz1.npy',Ex01)
np.save('DFT_GAS_1700/Dft_GAS_Ey_xyz1.npy',Ey01)
np.save('DFT_GAS_1700/Dft_GAS_Ez_xyz1.npy',Ez01)
...
np.save('DFT_GAS_1700/Dft_GAS_Ex_xyz0.npy',Ex00)
np.save('DFT_GAS_1700/Dft_GAS_Ey_xyz0.npy',Ey00)
np.save('DFT_GAS_1700/Dft_GAS_Ez_xyz0.npy',Ez00)
...
np.save('DFT_mode_volume_1700/DFT_mode_volume_Ex_xyz0.npy',Ex_mode_volume)
np.save('DFT_mode_volume_1700/DFT_mode_volume_Ey_xyz0.npy',Ey_mode_volume)
np.save('DFT_mode_volume_1700/DFT_mode_volume_Ez_xyz0.npy',Ez_mode_volume)
...
np.save('DFT_charge_density_1700/DFT_charge_density_Ex_all.npy',Ex_CD_all)
np.save('DFT_charge_density_1700/DFT_charge_density_Ey_all.npy',Ey_CD_all)
np.save('DFT_charge_density_1700/DFT_charge_density_Ez_all.npy',Ez_CD_all)


Ez_CD_pos = opt.sim.get_dft_array(dft_fields_CD_pos,mp.Ez,0)
np.save('DFT_charge_density_1700/DFT_charge_density_Ez_pos.npy',Ez_CD_pos)
Ez_CD_neg = opt.sim.get_dft_array(dft_fields_CD_neg,mp.Ez,0)
np.save('DFT_charge_density_1700/DFT_charge_density_Ez_neg.npy',Ez_CD_neg)
...
np.save('DFT_empty_GAS_1700/Dft_empty_GAS_Ex_xz.npy',Ex_xz_emp)
np.save('DFT_empty_GAS_1700/Dft_empty_GAS_Ey_xz.npy',Ey_xz_emp)
np.save('DFT_empty_GAS_1700/Dft_empty_GAS_Ez_xz.npy',Ez_xz_emp)
...
np.save('DFT_empty_GAS_1700/Dft_empty_GAS_Ex_yz.npy',Ex_yz_emp)
np.save('DFT_empty_GAS_1700/Dft_empty_GAS_Ey_yz.npy',Ey_yz_emp)
np.save('DFT_empty_GAS_1700/Dft_empty_GAS_Ez_yz.npy',Ez_yz_emp)
...
np.save('DFT_empty_GAS_1700/Dft_empty_GAS_Ex_xyz1.npy',Ex01_emp)
np.save('DFT_empty_GAS_1700/Dft_empty_GAS_Ey_xyz1.npy',Ey01_emp)
np.save('DFT_empty_GAS_1700/Dft_empty_GAS_Ez_xyz1.npy',Ez01_emp)
...
np.save('DFT_empty_GAS_1700/Dft_empty_GAS_Ex_xyz0.npy',Ex00_emp)
np.save('DFT_empty_GAS_1700/Dft_empty_GAS_Ey_xyz0.npy',Ey00_emp)
np.save('DFT_empty_GAS_1700/Dft_empty_GAS_Ez_xyz0.npy',Ez00_emp)
...
np.save('DFT_mode_volume_emp_1700/DFT_mode_volume_emp_Ex_xyz0.npy',Ex_mode_volume_emp)
np.save('DFT_mode_volume_emp_1700/DFT_mode_volume_emp_Ey_xyz0.npy',Ey_mode_volume_emp)
np.save('DFT_mode_volume_emp_1700/DFT_mode_volume_emp_Ez_xyz0.npy',Ez_mode_volume_emp)