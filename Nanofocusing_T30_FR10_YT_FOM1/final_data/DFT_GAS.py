...
dft_fields_xyz00 = opt.sim.add_dft_fields([mp.Ex,mp.Ey,mp.Ez,mp.Dx, mp.Dy, mp.Dz],
                                fcen,0,1,
                                center=mp.Vector3(0,0,0),
                                size=mp.Vector3(Sx,Sy,0),
                                yee_grid=False 
...
dft_fields_x0yz0 = opt.sim.add_dft_fields([mp.Ex,mp.Ey,mp.Ez,mp.Dx, mp.Dy, mp.Dz],
                                fcen,0,1,
                                center=mp.Vector3(0,0,0.01),
...
dft_fields_mode_volume = opt.sim.add_dft_fields([mp.Ex,mp.Ey,mp.Ez,mp.Dx, mp.Dy, mp.Dz],
                                fcen,0,1,
                                center=mp.Vector3(0,0,0),
...
Dx00 = opt.sim.get_dft_array(dft_fields_xyz00,mp.Dx,0)
Dy00 = opt.sim.get_dft_array(dft_fields_xyz00,mp.Dy,0)
Dz00 = opt.sim.get_dft_array(dft_fields_xyz00,mp.Dz,0)
np.save('DFT_GAS/Dft_GAS_Ex_xyz0.npy',Ex00)
np.save('DFT_GAS/Dft_GAS_Ey_xyz0.npy',Ey00)
np.save('DFT_GAS/Dft_GAS_Ez_xyz0.npy',Ez00)
np.save('DFT_GAS/Dft_GAS_Dx_xyz0.npy',Dx00)
np.save('DFT_GAS/Dft_GAS_Dy_xyz0.npy',Dy00)
np.save('DFT_GAS/Dft_GAS_Dz_xyz0.npy',Dz00)
